...
namespace PVTP {
	...
	public:
		 ...
		 */
		void setUB( const std::vector<TrajectorySegment*>& UB );
		
		/**
		 * Set the LB to a copy of another
		 */
		void setLB( const std::vector<TrajectorySegment*>& LB );
